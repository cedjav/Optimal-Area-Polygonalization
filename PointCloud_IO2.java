 ...
 */		   
public class PointCloud_IO2 {

	
	
	public static int[] readPolygon(String filename) {
		System.out.println("Reading polygon indexes from file: "+filename);
		...
		int n = vertices.size();
		System.out.print(n);
		System.out.print(" vertices read\n");
